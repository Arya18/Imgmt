                       ...
                       <c:if test="${HTTP_SESSION_USER.role=='Admin'}">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="/dashboard/createUsers"><i class="fa fa-angle-double-right"></i> Create users</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="/dashboard/products"><i class="fa fa-angle-double-right"></i> Products</a></li>
                            
                                <c:if test="${HTTP_SESSION_USER.role=='Checker'|| HTTP_SESSION_USER.role=='Maker' || HTTP_SESSION_USER.role=='Admin'}">
                                <li><a href="/dashboard/suppliers"><i class="fa fa-angle-double-right"></i> Suppliers</a></li>
                               </c:if> 
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-edit"></i> <span>Transaction master</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-table"></i> <span>Report master</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
