   ...
   <body class="skin-black">
	 <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Invoice
                        <small>${purchaseInvoice.cmpyPurchaseInvoiceNo}</small>
                    </h1>
                   <!--  <ol class="breadcrumb">
             ...
             <!--    <div class="pad margin no-print">
                ...
                <section class="content invoice">                    
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">
                                ...
                                <small class="pull-right">Date: ${purchaseInvoice.date}</small>
                            </h2>                            
                        </div><!-- /.col -->
                    </div>
                    <!-- info row -->
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            <b>Invoice ${purchaseInvoice.cmpyPurchaseInvoiceNo}</b><br/>
                            <br/>
