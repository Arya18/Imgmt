                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <c:forEach var="customerReport" items="${customerReports}">
                                         ...
                                         <tr>
                                            ...
                                            <td><a href="/dashboard/finalSaleInvoice?si=${customerReport.saleInvoice.saleInvoiceNo}">${customerReport.saleInvoice.cmpySaleInvoiceNo}</a> (${customerReport.saleInvoice.invoiceDate})</td>
