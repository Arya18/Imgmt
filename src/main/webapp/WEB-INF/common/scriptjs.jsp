...
<c:url value="/resources/js/plugins/datatables/jquery.dataTables.js" var="DataTableJs"/>
...
<c:url value="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-validator/0.5.3/js/bootstrapValidator.js" var="bootstrapValidatorJs"/>
        ...
        <script src="${AdminLTEApp}" type="text/javascript"></script>
         ...
         <script src="${DataTableJs}" type="text/javascript"></script>
          ...
          <c:url value="/resources/js/plugins/input-mask/jquery.inputmask.js" var="inputMask"/>
          
          <script src="${inputMask}" type="text/javascript"></script>
          
          <c:url value="/resources/js/plugins/input-mask/jquery.inputmask.date.extensions.js" var="dateExtension"/>
          <script src="${dateExtension}" type="text/javascript"></script>
          
          <c:url value="/resources/js/plugins/input-mask/jquery.inputmask.extensions.js" var="Extension"/>
          <script src="${Extension}" type="text/javascript"></script>
          
          <c:url value="/resources/js/plugins/daterangepicker/daterangepicker.js" var="dateRangePicker"/>
          <script src="${dateRangePicker}" type="text/javascript"></script>
     
         <c:url value="/resources/js/plugins/colorpicker/bootstrap-colorpicker.min.js" var="colorPicker"/>
