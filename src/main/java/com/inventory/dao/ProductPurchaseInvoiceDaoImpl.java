...
public class ProductPurchaseInvoiceDaoImpl implements ProductPurchaseInvoiceDao{
	...
	public ProductPurchaseInvoice getProductPurchaseInvoiceByIndoorSerialNo(
		...
		session = sessionFactory.openSession();
		@SuppressWarnings("unchecked")
		List<ProductPurchaseInvoice> productPurchaseInvoices = session.createQuery("FROM ProductPurchaseInvoice p WHERE p.indoorSerialNo=:sn AND p.sale=0").setParameter("sn",indoorserialNo).list();
